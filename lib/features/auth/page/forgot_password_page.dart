...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _handleSendCode(ForgotPasswordViewModel vm, S s) async {
  ...
  Future<void> _handleReset(ForgotPasswordViewModel vm, S s) async {
    final email = _emailCtrl.text.trim();
    ...
    final success = await vm.resetPassword(account: email, newPassword: pwd, code: code, isPhoneMode: false);

    if (!mounted) return;

    if (success) {
      context.showAppToast(message: s.resetPasswordSuccess, type: AppToastType.success);
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: vm.isLoading ? null : () => _handleReset(vm, s),
                      child: vm.isLoading
                          ? const SizedBox(
                              width: 22,
                              height: 22,
